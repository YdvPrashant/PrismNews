...
export default function NotFound() {
  return (
    <main className="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-6 pb-14 text-center">
      ...
      <p
        aria-hidden
        className="mt-4 text-[7rem] font-light leading-none tracking-tightest text-ink/[0.16] sm:text-[10rem]"
      >
        404
      </p>
      <h1 className="mt-4 text-3xl font-bold leading-tight tracking-tightest sm:text-4xl">
